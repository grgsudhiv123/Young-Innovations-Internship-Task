...
const TopNavbar = () => {
  ...
  return (
    <nav className="absolute top-0 z-1 w-full bg-white py-[clamp(0.5rem,3vw,1.25rem)] px-[clamp(1rem,4vw,2rem)] ">
      <div className="max-w-330 w-full mx-auto h-fit flex justify-between items-center">
