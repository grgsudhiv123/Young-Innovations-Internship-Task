        ...
        <div class="flex flex-row lg:flex-col gap-3">
          ${
            ...
            productData.imgURL
              .map(
                (url) => `
              <div class="aspect-80/90 max-w-[40px] lg:max-w-[50px] xl:max-w-20 w-full max-h-[40px] lg:max-h-[60px]  xl:max-h-[90px] h-full overflow-hidden">
          ...
          <div class="xs:size-[100px] sm:size-[200px] lg:size-[400px] xl:size-[556px] aspect-556/556 overflow-hidden">
            <img src=${
      ...
      <div class="w-[300px] md:w-[568px] space-y-3 xl:space-y-6">
        ...
        <div class="w-full flex justify-between py-[18px] gap-3 border-y-px border-gray-100">
          <div class="w-fit flex flex-row gap-2 md:gap-4 p-1 lg:p-2 items-center border border-gray-100 rounded-full">
            <button type="button" class="size-[24px] lg:size-[34px] rounded-full text-xs flex justify-center items-center bg-gray-50 cursor-pointer hover:bg-gray-200 transition-all duration-200 ease-in-out"><i class="fa-solid fa-plus text-sm"></i></button>
            <span class="font-medium text-xs lg:text-base leading-[150%]">5</span>
            <button type="button" class="size-[24px] lg:size-[34px] rounded-full text-xs flex justify-center items-center bg-gray-50 cursor-pointer hover:bg-gray-200 transition-all duration-200 ease-in-out"><i class="fa-solid fa-minus text-sm"></i></button>
          </div>
          <button class=" md:max-w-[250px] lg:max-w-[300px] w-fit md:w-full flex gap-1 md:gap-4 justify-center items-center rounded-full bg-(--light-green) hover:bg-(--success-dark) transition-all duration-200 ease-in-out cursor-pointer px-3">
          ...
          <button class="size-[36px] md:size-[40px] lg:size-[52px] rounded-full flex justify-center items-center bg-(--bg-button-green) hover:bg-(--light-green)/50 transition-all duration-200 ease-in-out cursor-pointer group">
            <i class="fa-regular fa-heart text-base lg:text-xl text-(--success-dark) group-hover:text-white"></i>
          </button>
        </div>
