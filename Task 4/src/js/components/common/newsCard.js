export function NewsCard(newsData) {
    ...
    return `
    <div class="col-span-6 md:col-span-4 border border-gray-100 rounded-lg overflow-hidden cursor-pointer group hover:shadow-lg transition-all duration-200 ease-in-out" aria-label="News card">
