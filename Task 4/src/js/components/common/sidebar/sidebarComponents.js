...
export function sidebarCard(product, cartProducts) {
    return `
            <div tabindex="0" id="cartProduct-${product.id}" class="flex gap-2 items-center bg-white cursor-pointer hover:bg-gray-50 p-2 transform-all duration-200 ease-in-out">
                ...
                <button id="sidebar-cartproduct-btn-${product.id}" class="size-6 border border-gray-500 rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-200 transition-all duration-200 ease-in-out" aria-label="Delete product">
