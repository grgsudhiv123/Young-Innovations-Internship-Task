    ...
    try {
        ...
        if (wishListData && wishListData.length !== 0) {
            ...
            for (const data of wishListData) {
                const removeWishlistBtn = document.getElementById(
                ...
                removeWishlistBtn.addEventListener('click', () => {
                    try {
                        ...
                        console.error(
                            'error while removing the wishlist',
                            error,
                        );
                ...
                const addWishlistToCartBtn = document.getElementById(
...
function wishlistTableRow(wishlist) {
    const discountedPrice =
        wishlist.baseprice -
        wishlist.baseprice * (wishlist.discount.replace('%', '') / 100);
